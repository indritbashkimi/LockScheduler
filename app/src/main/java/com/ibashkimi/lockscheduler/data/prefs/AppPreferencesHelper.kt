...
object AppPreferencesHelper :
    ...
    override var isAdminRationaleNeeded: Boolean
        get() = get(
            "show_admin_permission_rationale",
            false
        )
        set(value) = put(
            "show_admin_permission_rationale",
