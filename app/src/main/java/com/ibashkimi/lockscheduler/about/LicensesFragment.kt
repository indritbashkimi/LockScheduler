...
import com.ibashkimi.lockscheduler.databinding.AboutLibIntroBinding
import com.ibashkimi.lockscheduler.databinding.AboutLibraryBinding
import com.ibashkimi.lockscheduler.databinding.FragmentLicensesBinding
...
class LicensesFragment : Fragment() {
    ...
    private val libraries: Array<Library> = arrayOf(
        ...
        Library(
            ...
            R.string.material_components_license
        ),
        Library(
            R.string.material_dialogs_name,
            R.string.material_dialogs_website,
