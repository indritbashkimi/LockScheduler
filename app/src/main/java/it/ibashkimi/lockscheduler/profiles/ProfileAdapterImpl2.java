...
public class ProfileAdapterImpl2 extends ProfileAdapter<ProfileAdapterImpl2.ProfileViewHolder> {
    ...
    public ProfileAdapterImpl2(List<Profile> profiles, @NonNull ProfilesFragment.ProfileItemListener listener) {
        this(profiles, DEFAULT_ITEM_LAYOUT, listener);
    }

    public ProfileAdapterImpl2(List<Profile> profiles, int itemLayout, @NonNull ProfilesFragment.ProfileItemListener listener) {
