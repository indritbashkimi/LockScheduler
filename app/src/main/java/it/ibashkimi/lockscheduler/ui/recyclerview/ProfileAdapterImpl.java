...
public class ProfileAdapterImpl extends ProfileAdapter<ProfileAdapterImpl.ProfileViewHolder> {
    ...
    public ProfileAdapterImpl(Context context, List<Profile> profiles, @NonNull ClickListener clickListener) {
        this(context, profiles, DEFAULT_ITEM_LAYOUT, DEFAULT_MAP_STYLE, clickListener);
    }

    public ProfileAdapterImpl(Context context, List<Profile> profiles, int itemLayout, int mapType, @NonNull ClickListener clickListener) {
    ...
    public ProfileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ProfileViewHolder(itemView, mapType, getClickListener());
    }
                ...
                public void onMapReady(final GoogleMap googleMap) {
                    ...
                    googleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                        ...
                        public void onMapClick(LatLng latLng) {
                            if (getListener() != null)
                                getListener().onItemClicked(getLayoutPosition(), ProfileViewHolder.this);
                        }
                    });
